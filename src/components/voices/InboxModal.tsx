  ...
  <ModalShell titleId="inbox-title" onClose={onClose} className="max-w-6xl flex flex-col max-h-[80dvh]" contentClassName="flex flex-col h-full" returnFocusRef={returnFocusRef}>
      <div className="p-6 border-b border-card-border flex items-start justify-between gap-4">
              <div className="space-y-1">
                <h2 id="inbox-title" className="text-[24px] font-semibold flex items-center gap-3" style={{ fontFamily: '"Love Ya Like A Sister"' }}><img src={messagesIcon} alt="Messages" className="w-16 h-16 rounded-2xl shadow-sm" /> <span className="leading-tight">Messages</span></h2>
                  ...
                  >
                    <div className="flex items-start justify-between gap-4">
                      <div className="space-y-1 min-w-0">
                        <h3 className="font-semibold text-[18px] text-card-foreground leading-tight truncate" style={{ fontFamily: '"Love Ya Like A Sister"' }}>{active.subject}</h3>
