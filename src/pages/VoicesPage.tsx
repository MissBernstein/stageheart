      ...
      <div className="mb-8">
        <div className="flex items-start gap-3 mb-4 flex-col sm:flex-row sm:items-center">
          ...
          <div className="space-y-1 min-w-0">
            <h2 className="text-[24px] font-bold tracking-tight text-foreground break-words hyphens-auto" style={{ fontFamily: '"Love Ya Like A Sister"' }}>Discover Voices</h2>
        ...
        {filteredRecordings.map((recording) => (
          ...
          >
            ...
            <div className="flex items-center justify-between gap-3 px-4 pt-4">
              <h3 className="text-[18px] font-semibold text-foreground leading-tight break-words hyphens-auto flex-1 min-w-0 truncate" title={recording.title} style={{ fontFamily: '"Love Ya Like A Sister"' }}>{recording.title}</h3>
              <Button
                variant="ghost"
                size="sm"
